...
struct EdbStorageIOOps {
    EdbStorageIOOps() = default;

    // Non-copyable, non-movable (backends own OS resources).
    EdbStorageIOOps(const EdbStorageIOOps&) = delete;
    EdbStorageIOOps& operator=(const EdbStorageIOOps&) = delete;
    EdbStorageIOOps(EdbStorageIOOps&&) = delete;
    EdbStorageIOOps& operator=(EdbStorageIOOps&&) = delete;
